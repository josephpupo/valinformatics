...
// node_modules/unofficial-valorant-api/src/index.js
var require_src = __commonJS({
  "node_modules/unofficial-valorant-api/src/index.js"(exports, module) {
    ...
    module.exports = class {
      ...
      _validate(input) {
        for (let i = 0; Object.keys(input).length > i; i++) {
          if (Object.values(input)[i] == null)
            throw new Error(`Missing parameter: ${Object.keys(input)[i]}`);
        }
      }
      _query(input) {
        let query = new URLSearchParams();
        for (let i = 0; Object.values(input).length > i; i++) {
          if (Object.values(input)[i] && Object.values(input)[i] != "undefined")
            query.append(Object.keys(input)[i], Object.values(input)[i]);
        }
...
//# sourceMappingURL=unofficial-valorant-api.js.map
